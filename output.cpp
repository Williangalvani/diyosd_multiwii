...
void print_bottom_large_numbers()
{
    ...
    else
    {
        ...
        {
            delay5
            SPDR = letters[(3 << 3) + (screen_line - 8)];
            DimOn;
            delay12

            SPDR = letters[(21 << 3) + (screen_line - 8)];
            delay13

            SPDR = letters[(18 << 3) + (screen_line - 8)];
            delay2
        }
        else
        {
        ...
        if (screen_line > 7)
        {
            SPDR = letters[(13 << 3) + (screen_line - 8)];
            DimOn;
            delay13

            SPDR = letters[(1 << 3) + (screen_line - 8)];
            delay15;

            SPDR = letters[(8 << 3) + (screen_line - 8)];
            delay11
        }
        else
        {
